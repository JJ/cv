...
abstract: |
  (Mostly) Automatically generated summary of the academic curriculum.
...
There are *`r length(myPapers[ !is.na(myPapers$year) &  myPapers$year == thisYear,]$title)`* papers published this year. The paper with the most cites is *`r myPapers$title[1]`* [@jjproteng], with `r myPapers$cites[1]` cites. Evolution of paper citations per year is shown below.
...
This last year there are some papers with a non-null number of citations:
